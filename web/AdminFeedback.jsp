    ...
    <div>
        ...
        <footer>
            <div class="footer-content"
                ...
                <h3 style="color: yellow; text-align: left;">FOLLOWING ARE FEEDBACK DETAILS PROVIDED BY YOUR CUSTOMERS:
                </h3>
                <table class="booking"
                    ...
                    <tr>
                        <th class="bid" style="width: 0.2%;">FID</th>
                        <th class="uname" style="width: 1%;">USERNAME</th>
                        <th class="des" style="width: 5%;">FEEDBACK</th>
                    </tr>
                    <%
                        Connection con = null;
...
<script>
    var status = document.getElementById("status").value;
        if(status=="failed"){
            swal("Oops!", "No Feedbacks Submitted :(","error")
        }
</script>
</html>