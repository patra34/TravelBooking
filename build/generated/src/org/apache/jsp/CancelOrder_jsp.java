...
public final class CancelOrder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(session.getAttribute("name")==null){
      ...
      out.write("            <div class=\"container\" style=\"height: 429px;\">\n");
      out.write("                <div class=\"centered-text\">\n");
      out.write("                    <h2 style=\"color: white;\">Cancellation Form</h2>\n");
      out.write("                    <form class=\"login-form\" style=\"width: 450px;\" method=\"post\" action=\"Cancel\">\n");
      out.write("                        <div style=\"display: flex;\">\n");
      out.write("                            <span style=\"color: white; margin-right: 30px; width: 280px; margin-top: 10px;\">ENTER BOOKING ID:</span>\n");
      out.write("                            <input type=\"text\" name=\"bid\" placeholder=\"eg:-101\" width=\"30%\" required>\n");
      out.write("                        </div>\n");
      out.write("                        <button type=\"submit\" style=\"margin-top: 20px;\">Cancel Booking</button>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </main>\n");
      out.write("\n");
      out.write("        <footer>\n");
      out.write("            <div class=\"footer-content\" style=\"margin-top: 40px;\">\n");
      out.write("                <ul class=\"footer-list\">\n");
      ...
      out.write("            swal(\"Don't Worry\", \"Order cancelled successfully\",\"success\")\n");
      out.write("        } else if(status==\"failed\") {\n");
      out.write("            swal(\"Oops\", \"Order not found\",\"error\")\n");
      out.write("        } else {\n");
      out.write("            //nothing\n");
      out.write("        }\n");
      out.write("</script>\n");
